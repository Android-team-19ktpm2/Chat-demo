...
public class ContactAdapter extends ArrayAdapter<User> {
    ...
    public ContactAdapter(@NonNull Context context, int resource, @NonNull ArrayList<User> users) {
        super(context, R.layout.adapter_custom_contact, users);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View row = inflater.inflate(R.layout.adapter_custom_contact, null);

        User user = users.get(position);

        ImageView avatar=row.findViewById(R.id.adapter_contact_avatar);
/*        if(user.getAvatar().equals("default"))
            avatar.setImageResource(R.mipmap.ic_launcher);
        else*/
            Glide.with(context).load(default_avatar).into(avatar);

        TextView edt_email=row.findViewById(R.id.adapter_contact_email);
