...
public class ContactActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_signout=findViewById(R.id.contact_btn_signout);
        btn_signout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                auth.signOut();
                Toast.makeText(ContactActivity.this, "See you again!!!", Toast.LENGTH_SHORT).show();
        ...
        contacts=findViewById(R.id.contact_listview_contacts);
