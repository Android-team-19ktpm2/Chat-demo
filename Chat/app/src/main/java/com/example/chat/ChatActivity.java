...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference= FirebaseDatabase.getInstance().getReference("Users").child(enemy_user.getId());
...
/*                    img_avatar.setImageResource(R.mipmap.ic_launcher_round);*/
        ...
        /*TimeCheckThread timechecker= new TimeCheckThread(auth.getCurrentUser(),enemy_user,tv_status);*/
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot: dataSnapshot.getChildren())
                {
                    ...
                    if (msg != null)
                        if (msg.getSrc().equals(current_user.getUid()) && msg.getDst().equals(enemy_user.getId()) || msg.getSrc().equals(enemy_user.getId()) && msg.getDst().equals(current_user.getUid()))
                            messages.add(msg);
                }
    ...
    /*public void updateUI()
    {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                String online = enemy_user.getOnline();
                if (online.split("////")[0].equals("False")) {
                    if (!online.split("////")[1].equals("Undefine")) {
                        SimpleDateFormat formatter = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss");

                        Date offline = null, now = null;
                        try {
                            offline = formatter.parse(online.split("////")[1]);
                        ...
                        if (min_diff >= 60) {
                            ...
                            if (hour_diff >= 24) {
                                ...
                                tv_status.setText("Active " + day_diff + " days ago");
                            } else
                                tv_status.setText("Active " + hour_diff + " hours ago");
                        } else if (min_diff >= 1)
                            tv_status.setText("Active " + min_diff + " minutes ago");
                        else
                            tv_status.setText("Online");
                    }
                    else
                        tv_status.setText("Never been online");
                }
                else
                    tv_status.setText("Online");
            }
